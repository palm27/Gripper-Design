...
namespace Gripper_Design
{
    public partial class Main : Form
    {
        ...
        int surface_form_index = 0, Demolding_Force_input = 0, Pressure_input = 0,Cup_diameter=0;
        static Form _obj;
        ...
        public int SuctionDiameter_calculation(int F, int P)
        {
            double S_Diameter = 0;
            int result = 0;
            S_Diameter = F / P;
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            if(this.gripperSelection1.Gripper_index==0)
            {
                ...
                if (Count2 == 2)
                {
                    ...
                    //Demolding_Force_input = vacuum_Gripper1.D_force.Value;
                   // Pressure_input = vacuum_Gripper1.Pressure.Value;
                    ...
                    cup_number = CupNumber_calculation(400, 400);
